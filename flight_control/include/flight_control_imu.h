...
#ifndef FLIGHT_CONTROL_IMU_H
#define FLIGHT_CONTROL_IMU_H
...
public:
  ...
  geometry_msgs::Point start_global_position;
  ...
  void step(int inbound_limit,int outbount_limit,int break_limit);
